...
from JackMusic.utils.database import blacklist_chat, blacklisted_chats, whitelist_chat
...
@app.on_message(filters.command(["/blchats", "/blacklistedchats", "مجموعات"], "") & ~BANNED_USERS)
@language
