...
from JackMusic.utils.database import get_loop
from JackMusic.utils.decorators import AdminRightsCheck
from JackMusic.utils.inline import close_markup, stream_markup, stream_markup2
...
@app.on_message(
    command(["skip", "cskip", "next", "cnext","/skip","/next","/cskip","الي بعدو","تخطي"]) & ~filters.private & ~BANNED_USERS
)
@AdminRightsCheck
