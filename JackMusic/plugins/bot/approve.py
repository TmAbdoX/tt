...
bg_path = "JackMusic/assets/userinfo.png"
font_path = "JackMusic/assets/hiroko.ttf"
...
TEXT = environ.get("APPROVED_WELCOME_TEXT", "**❅─────✧❅✦❅✧─────❅\n🥀 مرحبًا {mention}\n\n🏓مرحبًا بك في المجموعة/القناة✨\n\n➻ {title}\n\n💞 أتمنى لك وقتًا ممتعًا هنا‌‌**\n**❅─────✧❅✦❅✧─────❅**")
                ...
                [
                    [
                        InlineKeyboardButton(
                            "اضف البوت الي قناتك او مجموعتك ⚡", url=f"https://t.me/{BOT_USERNAME}?startgroup=true")
                    ],[
                        InlineKeyboardButton(
