...
from JackMusic.utils.inline import botplaylist_markup
            ...
            try:
                ...
                if (
                    ...
                    return await message.reply_text(
                        ...
                        ), reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text= "الغاءالحظر", callback_data=f"unban_assistant")]])
                    )
