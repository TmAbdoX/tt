...
async def get_thumb(videoid):
    ...
    arial = ImageFont.truetype("JackMusic/assets/assets/font2.ttf", 30)
    font = ImageFont.truetype("JackMusic/assets/assets/font2.ttf", 30)
    title_font = ImageFont.truetype("JackMusic/assets/assets/font2.ttf", 45)
    ...
    play_icons = Image.open("JackMusic/assets/assets/play_icons.png")
