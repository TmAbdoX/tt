...
from JackMusic.utils.formatters import time_to_seconds
...
def stream_markup_timer(_, videoid, chat_id, played, dur):
    ...
    buttons  = [
        ...
        [
            ...
            InlineKeyboardButton(
                text="𝗦𝗸𝗜𝗣", callback_data=f"ADMIN Skip|{chat_id}"
            ),
        ],
        [
...
def panel_markup_5(_, videoid, chat_id):
    buttons = [ 
        ...
        [
            InlineKeyboardButton(text="𝗣𝗮𝗨𝘀𝗘", callback_data=f"ADMIN Pause|{chat_id}"),
            InlineKeyboardButton(text="𝗘𝗻𝗗 ", callback_data=f"ADMIN Stop|{chat_id}"),
            InlineKeyboardButton(text="𝗦𝗸𝗜𝗣", callback_data=f"ADMIN Skip|{chat_id}"),
